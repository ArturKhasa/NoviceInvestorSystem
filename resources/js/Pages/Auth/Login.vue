<template>
    <jet-authentication-card>
        ...
        <div class="flex flex-col justify-center mt-5 mb-3">
            <p class="mt-3 mx-auto text-lg text-blue-900">Войти в тестовый аккаунт</p>
            <div class="flex flex-col mt-4 mx-auto justify-center">
                <p class="mx-auto text-lg font-black">
                    <font-awesome-icon :icon="['fas', 'user']" :size="lg" />
                </p>
                <Link class="mt-2 bg-blue-900 text-lg px-4 py-2 font-black text-white rounded-md" method="post" as="button" type="button" :href="loginAsDemoUrl">Войти</Link>
            </div>
        </div>

        <div class="flex flex-col justify-center mt-8 mb-4">
            <hr class="w-11/12 mx-auto">
<!--            <p class="mt-3 mx-auto text-lg">Начни свою портфельную аналитику!</p>-->
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                <inertia-link v-if="canResetPassword" :href="route('password.request')" class="underline text-sm text-gray-600 hover:text-gray-900 mr-3">
                    Забыли пароль?
                </inertia-link>
