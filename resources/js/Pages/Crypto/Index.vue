              ...
              <div class="flex flex-col mx-auto w-full mt-8">
                <div>
                    <p class="text-xl font-bold lg:text-2xl">
                        Криптовалютные рыночные рейтинги</p>
                </div>
                  ...
                  <div v-for="(crypto, index) in cryptoData" :key="index" class="flex flex-wrap sm:flex-row sm:items-center sm:justify-between w-full py-2">
                      ...
                      <div class="flex order-4 w-full mt-2 sm:order-3 sm:w-3/12">
                        ...
                        <div class="flex w-1/2 sm:flex-col">
                          <p class="flex items-center text-xs md:text-sm lg:text-lg">Цена: </p>
                          <p class="text-sm font-bold ml-2 sm:ml-0 md:text-base lg:text-xl">${{ crypto.price }}</p>
                        </div>

                        <!-- AMOUNT -->
                        <div class="flex w-1/2 sm:flex-col">
                            <p class="flex items-center text-xs md:text-sm lg:text-lg">Куплено: </p>
                      ...
                      <div class="flex order-5 w-full mt-2 sm:order-4 sm:w-5/12">
                          ...
                          <div class="flex flex-col w-4/12 items-baseline mb-2 sm:mb-0">
                              <p class="text-xs md:text-sm lg:text-lg">Изм. цены 1ч: </p>
                              <p
                          ...
                          <!-- 24h Change -->
                          <div class="flex flex-col w-4/12 items-baseline mb-2 sm:mb-0">
                              <p class="text-xs md:text-sm lg:text-lg">Изм. цены 24ч: </p>
                          ...
                          <!-- 7d Change -->
                          <div class="flex flex-col w-4/12 items-baseline mb-2 sm:mb-0">
                              <p class="text-xs md:text-sm lg:text-lg">Изм. цены 7д: </p>
                ...
                <div class="flex justify-between w-52 mx-auto mt-10">
                    <button @click="goToPrev" class="bg-blue-900 text-white font-bold py-1 px-2 rounded-md lg:text-lg">Назад</button>
                    <div class="flex">
                      <p class="border-2 border-gray-200 font-bold py-1 px-2">{{ currentPage }}</p>
                    </div>
                    <button @click="goToNext" class="bg-blue-900 text-white font-bold py-1 px-2 rounded-md lg:text-lg">Вперед</button>
                </div>
              </div>
